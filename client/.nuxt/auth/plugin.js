...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/auth/login","method":"post","propertyName":"payload.user.token"},"logout":{"url":"/api/auth/logout","method":"post"},"user":{"url":"/user","method":"get","propertyName":"payload"}},"tokenRequired":true,"tokenType":"Bearer","_name":"local"}))
